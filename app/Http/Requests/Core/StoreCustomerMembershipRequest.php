...
class StoreCustomerMembershipRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('memberships.sell');
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'membership_plan_id' => ['required', 'integer', Rule::exists('membership_plans', 'id')->where('tenant_id', $tenantId)->where('is_active', true)],
