    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-2xl">
        <form method="POST" action="{{ route('platform.subscription-plans.update', $plan) }}" class="space-y-4">
            ...
            <div>
                ...
                <x-text-input id="branch_limit" class="block mt-1 w-full sm:w-40" type="number" min="1" max="1000" name="branch_limit" :value="old('branch_limit', $plan->branch_limit)" required />
