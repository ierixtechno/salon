    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                @else
                    <form method="POST" action="{{ route('salon.consultations.store', $customer) }}" class="space-y-4">
                        @csrf
                        ...
                        <div>
                            <x-input-label for="concerns" value="Hair/scalp concerns" />
                        ...
                        <div>
                            <x-input-label for="recommendation" value="Treatment recommendation" />
                        ...
                        <div>
                            <x-input-label for="color_formula" value="Color formula (if applicable)" />
                            <textarea id="color_formula" name="color_formula" rows="2"
                                class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('color_formula') }}</textarea>
                            <x-input-error :messages="$errors->get('color_formula')" class="mt-2" />
                        </div>
