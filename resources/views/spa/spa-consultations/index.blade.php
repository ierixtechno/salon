<x-app-layout>
    <x-slot name="header">Spa Consultations — {{ $customer->name }}</x-slot>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex gap-4 text-sm">
                    ...
                    <a href="{{ route('spa.profile.edit', $customer) }}" class="text-indigo-600 hover:text-indigo-800">Spa profile</a>
                </div>
                @can('spa-consultations.create')
                    <a href="{{ route('spa.consultations.create', $customer) }}">
