<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @can('create', App\Domain\Core\Models\ProductCategory::class)
    ...
    <div class="py-8">
        <div class="px-4 sm:px-6 lg:px-8">
                    ...
                    <table class="min-w-full text-sm">
                        <thead class="bg-indigo-100 text-indigo-800">
                            <tr>
                                ...
                                <th class="text-left px-4 py-2 font-semibold text-base">Products</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($categories as $category)
                                <tr>
                                    <td class="px-4 py-2">
                                        <a href="{{ route('product-categories.edit', $category) }}" class="text-indigo-600 hover:text-indigo-800 font-medium">
                                            {{ $category->name }}
                                        </a>
                                    </td>
            ...
            <a href="{{ route('products.index') }}" class="inline-block mt-4 text-sm text-gray-500 hover:text-gray-700">View products &rarr;</a>
        </div>
    </div>
</x-app-layout>
