        ...
        <div class="px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            @can('delete', $category)
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <p class="text-xs text-gray-500 mb-4">Existing products keep working — this just hides it from new-product pickers.</p>
                    <form method="POST" action="{{ route('product-categories.destroy', $category) }}" onsubmit="return confirm('Deactivate this category?')">
                        @csrf
                        @method('DELETE')
