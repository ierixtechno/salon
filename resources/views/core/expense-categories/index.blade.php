                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($categories as $category)
                                <tr>
                                    <td class="px-4 py-2">
                                        <a href="{{ route('expense-categories.edit', $category) }}" class="text-indigo-600 hover:text-indigo-800 font-medium">
                                            {{ $category->name }}
                                        </a>
                                    </td>
                                    <td class="px-4 py-2">
                            ...
                            @empty
                                <tr>
                                    <td colspan="2" class="px-4 py-6 text-center text-gray-500">No expense categories yet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
