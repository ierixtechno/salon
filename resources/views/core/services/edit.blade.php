<x-app-layout>
    ...
    <div class="py-8">
        <div class="px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            @php
                $hasConsumables = $products->isNotEmpty();
                $canDeactivateService = auth()->user()->can('delete', $service);
                ...
                if ($canDeactivateService) {
                    $tabs['danger'] = 'Danger Zone';
                }

                $defaultTab = $errors->has('branches.*') ? 'availability' : 'details';
            @endphp
