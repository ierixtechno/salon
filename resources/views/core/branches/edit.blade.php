<x-app-layout>
    ...
    <div class="py-8">
        <div class="px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            @php
                $canDeactivateBranch = auth()->user()->can('delete', $branch);
                ...
                if ($canDeactivateBranch) {
                    $tabs['danger'] = 'Danger Zone';
                }

                $defaultTab = $errors->has('hours.*') ? 'hours' : 'details';
            @endphp
