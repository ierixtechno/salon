                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                                    ...
                                    <td class="px-4 py-2 text-right">
                                        @if ($plan->is_active)
                                            @can('memberships.sell')
                                                <a href="{{ route('membership-plans.sell', $plan) }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">Sell</a>
                                            @endcan
                                        @endif
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="7" class="px-4 py-6 text-center text-gray-500">No membership plans yet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
