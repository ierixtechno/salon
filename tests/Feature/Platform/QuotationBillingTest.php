...
test('creating a tenant requires a package — nothing is created without one', function () {
    ...
    $this->actingAs($admin, 'platform')->post('/platform/tenants', [
        ...
        'owner_name' => 'Owner',
        'owner_phone' => '9876543210', 'owner_email' => 'noplan@example.com',
...
test('a tenant created by Super Admin can log in straight away and lands on its quotation', function () {
    ...
    $this->actingAs($admin, 'platform')->post('/platform/tenants', [
        ...
        'billing_state' => config('platform.state'),
        'owner_name' => 'Owner',
        'owner_phone' => '9876543210', 'owner_email' => 'adminmade@example.com',
        'owner_password' => 'password123',
        'owner_password_confirmation' => 'password123',
    ])->assertRedirect();
...
test('creating a tenant with a plan selected skips the separate quotation step', function () {
    ...
    $response = $this->actingAs($admin, 'platform')->post('/platform/tenants', [
        ...
        'billing_state' => config('platform.state'),
        'owner_name' => 'Owner',
        'owner_phone' => '9876543210', 'owner_email' => 'onestep@example.com',
        'owner_password' => 'password123',
        'owner_password_confirmation' => 'password123',
    ]);
...
test('creating a tenant with a plan but no billing state is rejected before anything is created', function () {
    ...
    $this->actingAs($admin, 'platform')->post('/platform/tenants', [
        ...
        'subscription_plan_id' => $plan->id,
        'owner_name' => 'Owner',
        'owner_phone' => '9876543210', 'owner_email' => 'missingstate@example.com',
        'owner_password' => 'password123',
        'owner_password_confirmation' => 'password123',
...
test('creating a tenant with a plan honours an amount override on the auto-generated quotation', function () {
    ...
    $this->actingAs($admin, 'platform')->post('/platform/tenants', [
        ...
        'owner_name' => 'Owner',
        'owner_phone' => '9876543210', 'owner_email' => 'discounted@example.com',
        'owner_password' => 'password123',
        'owner_password_confirmation' => 'password123',
    ])->assertRedirect();
